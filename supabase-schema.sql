...
CREATE TABLE appointments (
  ...
  notes TEXT,
  payment_status VARCHAR(20) CHECK (payment_status IN ('pending', 'completed', 'refunded')) DEFAULT 'pending',
  created_at TIMESTAMP DEFAULT NOW(),
  updated_at TIMESTAMP DEFAULT NOW()
);
...
CREATE TABLE payments (
  ...
  payment_method VARCHAR(20) CHECK (payment_method IN ('card', 'bkash', 'nagad', 'rocket', 'insurance')),
...
('PAY004', 'A006', 'P006', 1800.00, 'nagad', 'completed', 'NAGAD20251230004', '2025-12-30 15:20:00', NOW()),
